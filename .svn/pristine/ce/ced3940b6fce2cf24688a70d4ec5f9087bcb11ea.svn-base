...
public class Hotelinfo implements Serializable{
	...
	public String toString() {
		return "Hotelbasicinfo [id=" + id + ", urlid=" + urlid + ", name=" + name + ", address=" + address
				+ ", longitude=" + longitude + ", latitude=" + latitude + ", star=" + star + ", price=" + price
				+ ", datasource=" + datasource + ", grade=" + grade + ", gradenum=" + gradenum + ", beennum=" + beennum
				+ ", whantto=" + whantto + ", createdate=" + createdate + ", creator=" + creator + ", creatorid="
				+ creatorid + ", remark=" + remark + ", introduction=" + introduction + "]";
	}
