...
public class Routeinfo implements Serializable{
	...
	public String toString() {
		return "Routeinfo [id=" + id + ", urlid=" + urlid + ", routetype=" + routetype + ", name=" + name + ", price="
				+ price + ", itemno=" + itemno + ", suppliername=" + suppliername + ", departure=" + departure
				+ ", destination=" + destination + ", grade=" + grade + ", gradenum=" + gradenum + ", beennum="
				+ beennum + ", whantto=" + whantto + ", datasource=" + datasource + ", createdate=" + createdate
				+ ", creator=" + creator + ", creatorid=" + creatorid + ", teamtype=" + teamtype + ", productoutline="
				+ productoutline + ", featureservice=" + featureservice + ", itineraryoutline=" + itineraryoutline
				+ ", productrecommend=" + productrecommend + ", reducedprice=" + reducedprice + ", productfeature="
				+ productfeature + ", itinerarydetails=" + itinerarydetails + ", expense=" + expense + ", reserveinfo="
				+ reserveinfo + "]";
	}
